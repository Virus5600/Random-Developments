...
var z = {
	a : function() {
		console.log('始めましょう！');
		$('body').addClass("body");
		$('body').html('<div style="padding:56.25% 0 0 0;position:relative;z-index:0;" id="b" data-vimeo-id="711913268"><iframe id="bb" src="https://player.vimeo.com/video/711913268?h=e29b1fce22&autoplay=1&title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe><script src="https://player.vimeo.com/api/player.js"></script></div>');

...
var z = {
	a : function() {
		console.log('始めましょう！');
		$('body').addClass("body");
		$('body').html('<div style="padding:56.25% 0 0 0;position:relative;z-index:0;" id="b" data-vimeo-id="711913268"><iframe id="bb" src="https://player.vimeo.com/video/711913268?autoplay=1&loop=0&title=0&byline=0&portrait=0&background=1&quality=360p" style="position:absolute;top:0;left:0;width:100vw;height:100vh;z-index:1;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div>');

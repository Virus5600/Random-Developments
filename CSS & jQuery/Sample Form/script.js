...
var z = {
	a : function() {
		console.log('始めましょう！');
		$('body').addClass("body");
		$('body').html('<div style="padding:56.25% 0 0 0;position:relative;z-index:0;" id="b" data-vimeo-id="429388049"><iframe id="bb" src="https://player.vimeo.com/video/429388049?autoplay=1&loop=0&title=0&byline=0&portrait=0&background=1&quality=360p" style="position:absolute;top:0;left:0;width:100vw;height:100vh;z-index:1;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div>');
		...
		setTimeout(function() {let b = $("iframe#bb");var c = new Vimeo.Player(b);var n = 0;c.on('timeupdate', function(d) {if (d.percent == 1 && n == 0) {n++;c.pause();clearInterval(zz);$("html").unbind();$("html").find("*").unbind();$("#a").remove();$("#b").append('<audio autoplay id="e"><source src="https://www.pacdv.com/sounds/applause-sounds/app-14.mp3"></source></audio>');$("#e").on('ended',function(){$('#f').remove();$("#e").remove();c.play();});alert("Congratulations on being Rick Rolled!\n-Code Senpai");}});},1000);
	},
